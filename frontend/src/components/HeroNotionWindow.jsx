...
export default function HeroNotionWindow({ onOpenApp }) {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto rounded-xl border border-gray-200/80 shadow-2xl bg-white overflow-hidden text-[#37352f] text-[13px] font-sans">
      ...
      <div className="h-10 bg-[#f7f6f3] border-b border-gray-200 flex items-center justify-between px-4 select-none">
        ...
        <div className="flex items-center gap-3 text-gray-500 text-xs">
          <button
            onClick={onOpenApp}
            className="hover:text-black font-medium flex items-center gap-1"
          >
            <span>Share</span>
          </button>
      ...
      <div className="flex min-h-[500px]">
        ...
        <aside className="w-56 bg-[#f7f6f3] border-r border-gray-200 p-3 flex flex-col justify-between select-none">
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between px-1 py-1 hover:bg-[#efedea] rounded cursor-pointer transition-colors">
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded bg-amber-600 text-white font-bold text-[10px] flex items-center justify-center">
                  R
                </div>
            ...
            {/* Teamspaces */}
            <div className="pt-2">
              <div className="text-[10px] font-semibold text-gray-400 px-2 uppercase tracking-wider mb-1">
                Teamspaces
              </div>
                  ...
                  <div className="pl-4 space-y-0.5 mt-0.5">
                    <button
                      ...
                      className={`w-full text-left flex items-center gap-2 px-2 py-1 rounded transition-colors ${
                        activeTab === "dashboard"
                          ? "bg-[#e8e7e3] font-semibold text-gray-900"
                          : "text-gray-600 hover:bg-[#efedea]"
                      }`}
                    >
                      <span>📊 Dashboard</span>
                    </button>
        ...
        <main className="flex-1 bg-white p-8 overflow-y-auto relative">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-lg bg-[#faf9f7] border border-gray-200/70 hover:border-gray-300 transition-all">
                  <div className="flex items-center justify-between text-xs text-gray-500 mb-1">
                    ...
                    <span className="bg-gray-200/80 text-gray-600 text-[10px] px-1.5 py-0.5 rounded font-medium">
                      Test data
                    </span>
                  </div>
          ...
          {activeTab === "transactions" && (
            <div className="space-y-4">
              <div className="flex items-center justify-between pb-2 border-b border-gray-100">
                ...
                <button
                  onClick={onOpenApp}
                  className="text-xs bg-black text-white px-2.5 py-1 rounded"
                >
                  New Transaction
                </button>
              </div>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      >
                        ...
                        <td
                          className={`p-2.5 text-right font-mono font-semibold ${row.positive ? "text-emerald-600" : "text-gray-800"}`}
                        >
                          {row.amt}
                        </td>
                      </tr>
          ...
          <div className="absolute bottom-4 right-4 w-7 h-7 rounded-full bg-gray-100 hover:bg-gray-200 border border-gray-300 flex items-center justify-center cursor-pointer text-gray-600 transition-all shadow-sm">
