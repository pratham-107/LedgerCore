      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 bg-[#faf9f7] p-4 md:p-8 rounded-2xl border border-gray-200/80 shadow-sm mb-16">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm flex flex-col justify-between min-h-[380px]">
            ...
            <div className="pt-6 border-t border-gray-100 flex justify-between items-center text-sm">
              ...
              <span className="text-xl font-bold text-gray-950 font-mono">{curr.amount}</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <h4 className="font-bold text-gray-900 text-sm">Custom templates</h4>
                <span className="bg-emerald-100 text-emerald-800 text-[9px] font-extrabold px-1.5 py-0.2 rounded">SOON</span>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">
                Match your brand identity using one of our ready-to-use professional templates.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h4 className="font-bold text-gray-900 text-sm mb-1">PDF export</h4>
              <p className="text-xs text-gray-600 leading-relaxed">
                Export and share your ledger invoices directly as downloadable PDF files.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h4 className="font-bold text-gray-900 text-sm mb-1">Custom status</h4>
              <p className="text-xs text-gray-600 leading-relaxed">
                Organize billing workflows with custom status tags and automated reminders.
              </p>
            </div>
          </div>
        </div>
